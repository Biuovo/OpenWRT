...
install_custom_feed() {
    ...
    case "$BUILD_MODEL" in
        r76s_immwrt)
            required_feed_dirs=(
                luci-app-netspeedtest speedtest-cli luci-app-cpufreq
            ...
            custom_feed_sources=(
                "sbwml/openwrt_pkgs|https://github.com/sbwml/openwrt_pkgs.git|main|luci-app-netspeedtest speedtest-cli luci-app-cpufreq"
